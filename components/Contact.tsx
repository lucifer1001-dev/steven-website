...
export default function Contact() {
  ...
  return <section className="page-section" aria-labelledby="contact-title"><div className="section-shell">
    <div className="page-intro"><p className="eyebrow">Contact</p><h1 id="contact-title">Let’s talk about the product behind the roadmap.</h1><p>I’m open to Senior Frontend Engineer, Senior React Engineer, Frontend Platform Engineer, and AI Product Engineer opportunities.</p></div>
    <div className="mt-16 grid gap-8 lg:grid-cols-[0.75fr_1.25fr]">
      <aside className="content-card self-start"><p className="eyebrow">Direct contact</p><dl className="mt-7 space-y-6"><div><dt className="text-xs uppercase tracking-wider text-slate-500">Email</dt><dd className="mt-2"><a className="text-white hover:text-cyan-200" href="mailto:chensteven890@outlook.com">chensteven890@outlook.com</a></dd></div><div><dt className="text-xs uppercase tracking-wider text-slate-500">Phone</dt><dd className="mt-2"><a className="text-white hover:text-cyan-200" href="tel:+19177648247">+1 (917) 764-8247</a></dd></div><div><dt className="text-xs uppercase tracking-wider text-slate-500">Location</dt><dd className="mt-2 text-white">Vancouver, WA, USA</dd></div><div><dt className="text-xs uppercase tracking-wider text-slate-500">Website</dt><dd className="mt-2"><a className="text-white hover:text-cyan-200" href="https://stevenchen.life">stevenchen.life</a></dd></div></dl></aside>
      <form onSubmit={handleSubmit} className="content-card" aria-label="Contact Steven Blake Chen">
